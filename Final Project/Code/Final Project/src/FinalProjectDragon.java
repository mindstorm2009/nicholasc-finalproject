	...
	public static void main(String[] args)
	{
		...
		do
		{
			...
			case 2:
				...
				System.out.println("4. Command " + pup.getName() + " to sit");
				System.out.println("5. Command " + pup.getName() + " to lie down");
				System.out.println("6. Quit");
				System.out.print("Please make a selection (1, 2, 3, 4, 5, or 6): ");
