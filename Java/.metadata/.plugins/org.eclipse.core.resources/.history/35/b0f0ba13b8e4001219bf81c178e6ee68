	...
	public static void main(String[] args)
	{
		...
		do
		{
			...
			if (pup.getEnergyLevel() < 15)
			{
				...
				System.out.println("To put " + pup.getName() + " in bed please press 2 , Enter, 2, and then Enter Again" + "\n");
			}
			...
			if (pup.getHunger() < 15)
			{
				...
				System.out.println("To feed " + pup.getName() + " please press 2, Enter, 3, and then Enter again" + "\n");
			}
			...
			if (pup.getHappiness() < 15)
			{
				...
				System.out.println("To play with " + pup.getName() + " please press 2 , Enter, 1, and then Enter again" + "\n");
			}
			...
			if (pup.getHappiness() < 15)
			{
				...
				System.out.println("To give water to " + pup.getName() + " please press 2 , Enter, 1, and then Enter again" + "\n");
			}
			...
			case 2:
				...
				case 5:
					...
					case 14:
						...
						break;
					case 15:
						System.out.println(pup.getName() + " gives you a kiss" + "\n");
